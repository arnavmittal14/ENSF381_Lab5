...
function addMatrices(matrix1, matrix2) {
  if (
    ...
    console.error(
      "Matrix addition is not possible. Dimensions of matrices are different."
    );
    return;
  }
...
const subtractMatrices = function (matrix1, matrix2) {
  if (
    ...
    console.error(
      "Matrix subtraction is not possible. Dimensions of matrices are different."
    );
    return;
  }
...
const multiplyMatrices = (matrix1, matrix2) => {
  if (matrix1[0].length !== matrix2.length) {
    console.error(
      "Matrix multiplication is not possible. Inner dimensions do not match."
    );
    return;
  }
